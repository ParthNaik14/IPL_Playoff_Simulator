...
# ---------------------------------------------------------------------------
updated_points_data = {
    "Royal Challengers Bengaluru": {"points": 4, "matches": 3, "runs_for": 654, "overs_faced": "55.4", "runs_against": 610, "overs_bowled": "58.0"},
    "Punjab Kings": {"points": 7, "matches": 4, "runs_for": 598, "overs_faced": "56.4", "runs_against": 590, "overs_bowled": "60.0"},
    ...
    "Sunrisers Hyderabad": {"points": 2, "matches": 4, "runs_for": 802, "overs_faced": "80.0", "runs_against": 747, "overs_bowled": "74.2"},
    "Rajasthan Royals": {"points": 8, "matches": 4, "runs_for": 690, "overs_faced": "61.1", "runs_against": 655, "overs_bowled": "71.0"},
    "Chennai Super Kings": {"points": 2, "matches": 4, "runs_for": 755, "overs_faced": "80.0", "runs_against": 777, "overs_bowled": "70.5"},
}
...
elo_ratings = {
    ...
    "Royal Challengers Bengaluru":           1521.88,
    "Punjab Kings":                          1546.88,
    "Lucknow Super Giants":                  1496.03,
    "Kolkata Knight Riders":                 1467.36,
    "Rajasthan Royals":                      1552.04,
    "Sunrisers Hyderabad":                   1470.22,
    "Delhi Capitals":                        1499.19,
    "Chennai Super Kings":                   1462.8,
}

ELO_K = 32

recent_form = {
    "Royal Challengers Bengaluru":           [1, 1, 0],
