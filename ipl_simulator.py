...
# ---------------------------------------------------------------------------
updated_points_data = {
    "Royal Challengers Bengaluru": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                                    "overs_bowled": "0.0"},
    "Punjab Kings": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                     "overs_bowled": "0.0"},
    "Mumbai Indians": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                       "overs_bowled": "0.0"},
    "Gujarat Titans": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                       "overs_bowled": "0.0"},
    "Delhi Capitals": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                       "overs_bowled": "0.0"},
    "Kolkata Knight Riders": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                              "overs_bowled": "0.0"},
    "Lucknow Super Giants": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                             "overs_bowled": "0.0"},
    "Sunrisers Hyderabad": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                            "overs_bowled": "0.0"},
    "Rajasthan Royals": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                         "overs_bowled": "0.0"},
    "Chennai Super Kings": {"points": 0, "matches": 0, "runs_for": 0, "overs_faced": "0.0", "runs_against": 0,
                            "overs_bowled": "0.0"},
}
...
# ---------------------------------------------------------------------------
remaining_matches = [
    {"home": "Royal Challengers Bengaluru", "away": "Sunrisers Hyderabad", "venue": "Bengaluru", "result": None,
     "margin": None, "applied": False},
    {"home": "Mumbai Indians", "away": "Kolkata Knight Riders", "venue": "Mumbai", "result": None, "margin": None,
     "applied": False},
    {"home": "Rajasthan Royals", "away": "Chennai Super Kings", "venue": "Guwahati", "result": None, "margin": None,
     "applied": False},
    {"home": "Punjab Kings", "away": "Gujarat Titans", "venue": "Mullanpur", "result": None, "margin": None,
     "applied": False},
    {"home": "Lucknow Super Giants", "away": "Delhi Capitals", "venue": "Lucknow", "result": None, "margin": None,
     "applied": False},
    {"home": "Kolkata Knight Riders", "away": "Sunrisers Hyderabad", "venue": "Kolkata", "result": None, "margin": None,
     "applied": False},
    {"home": "Chennai Super Kings", "away": "Punjab Kings", "venue": "Chennai", "result": None, "margin": None,
     "applied": False},
    {"home": "Delhi Capitals", "away": "Mumbai Indians", "venue": "Delhi", "result": None, "margin": None,
     "applied": False},
    {"home": "Gujarat Titans", "away": "Rajasthan Royals", "venue": "Ahmedabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Sunrisers Hyderabad", "away": "Lucknow Super Giants", "venue": "Hyderabad", "result": None,
     "margin": None, "applied": False},
    {"home": "Royal Challengers Bengaluru", "away": "Chennai Super Kings", "venue": "Bengaluru", "result": None,
     "margin": None, "applied": False},
    {"home": "Kolkata Knight Riders", "away": "Punjab Kings", "venue": "Kolkata", "result": None, "margin": None,
     "applied": False},
    {"home": "Rajasthan Royals", "away": "Mumbai Indians", "venue": "Guwahati", "result": None, "margin": None,
     "applied": False},
    {"home": "Delhi Capitals", "away": "Gujarat Titans", "venue": "Delhi", "result": None, "margin": None,
     "applied": False},
    {"home": "Kolkata Knight Riders", "away": "Lucknow Super Giants", "venue": "Kolkata", "result": None,
     "margin": None, "applied": False},
    {"home": "Rajasthan Royals", "away": "Royal Challengers Bengaluru", "venue": "Guwahati", "result": None,
     "margin": None, "applied": False},
    {"home": "Punjab Kings", "away": "Sunrisers Hyderabad", "venue": "Mullanpur", "result": None, "margin": None,
     "applied": False},
    {"home": "Chennai Super Kings", "away": "Delhi Capitals", "venue": "Chennai", "result": None, "margin": None,
     "applied": False},
    {"home": "Lucknow Super Giants", "away": "Gujarat Titans", "venue": "Lucknow", "result": None, "margin": None,
     "applied": False},
    {"home": "Mumbai Indians", "away": "Royal Challengers Bengaluru", "venue": "Mumbai", "result": None, "margin": None,
     "applied": False},
    {"home": "Sunrisers Hyderabad", "away": "Rajasthan Royals", "venue": "Hyderabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Chennai Super Kings", "away": "Kolkata Knight Riders", "venue": "Chennai", "result": None, "margin": None,
     "applied": False},
    {"home": "Royal Challengers Bengaluru", "away": "Lucknow Super Giants", "venue": "Bengaluru", "result": None,
     "margin": None, "applied": False},
    {"home": "Mumbai Indians", "away": "Punjab Kings", "venue": "Mumbai", "result": None, "margin": None,
     "applied": False},
    {"home": "Gujarat Titans", "away": "Kolkata Knight Riders", "venue": "Ahmedabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Royal Challengers Bengaluru", "away": "Delhi Capitals", "venue": "Bengaluru", "result": None,
     "margin": None, "applied": False},
    {"home": "Sunrisers Hyderabad", "away": "Chennai Super Kings", "venue": "Hyderabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Kolkata Knight Riders", "away": "Rajasthan Royals", "venue": "Kolkata", "result": None, "margin": None,
     "applied": False},
    {"home": "Punjab Kings", "away": "Lucknow Super Giants", "venue": "Mullanpur", "result": None, "margin": None,
     "applied": False},
    {"home": "Mumbai Indians", "away": "Gujarat Titans", "venue": "Ahmedabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Sunrisers Hyderabad", "away": "Delhi Capitals", "venue": "Hyderabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Lucknow Super Giants", "away": "Rajasthan Royals", "venue": "Lucknow", "result": None, "margin": None,
     "applied": False},
    {"home": "Mumbai Indians", "away": "Chennai Super Kings", "venue": "Mumbai", "result": None, "margin": None,
     "applied": False},
    {"home": "Royal Challengers Bengaluru", "away": "Gujarat Titans", "venue": "Bengaluru", "result": None,
     "margin": None, "applied": False},
    {"home": "Delhi Capitals", "away": "Punjab Kings", "venue": "Delhi", "result": None, "margin": None,
     "applied": False},
    {"home": "Rajasthan Royals", "away": "Sunrisers Hyderabad", "venue": "Jaipur", "result": None, "margin": None,
     "applied": False},
    {"home": "Gujarat Titans", "away": "Chennai Super Kings", "venue": "Ahmedabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Lucknow Super Giants", "away": "Kolkata Knight Riders", "venue": "Lucknow", "result": None,
     "margin": None, "applied": False},
    {"home": "Delhi Capitals", "away": "Royal Challengers Bengaluru", "venue": "Delhi", "result": None, "margin": None,
     "applied": False},
    {"home": "Punjab Kings", "away": "Rajasthan Royals", "venue": "Mullanpur", "result": None, "margin": None,
     "applied": False},
    {"home": "Mumbai Indians", "away": "Sunrisers Hyderabad", "venue": "Mumbai", "result": None, "margin": None,
     "applied": False},
    {"home": "Gujarat Titans", "away": "Royal Challengers Bengaluru", "venue": "Ahmedabad", "result": None,
     "margin": None, "applied": False},
    {"home": "Rajasthan Royals", "away": "Delhi Capitals", "venue": "Jaipur", "result": None, "margin": None,
     "applied": False},
    {"home": "Chennai Super Kings", "away": "Mumbai Indians", "venue": "Chennai", "result": None, "margin": None,
     "applied": False},
    {"home": "Sunrisers Hyderabad", "away": "Kolkata Knight Riders", "venue": "Hyderabad", "result": None,
     "margin": None, "applied": False},
    {"home": "Gujarat Titans", "away": "Punjab Kings", "venue": "Ahmedabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Mumbai Indians", "away": "Lucknow Super Giants", "venue": "Mumbai", "result": None, "margin": None,
     "applied": False},
    {"home": "Delhi Capitals", "away": "Chennai Super Kings", "venue": "Delhi", "result": None, "margin": None,
     "applied": False},
    {"home": "Sunrisers Hyderabad", "away": "Punjab Kings", "venue": "Hyderabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Lucknow Super Giants", "away": "Royal Challengers Bengaluru", "venue": "Lucknow", "result": None,
     "margin": None, "applied": False},
    {"home": "Delhi Capitals", "away": "Kolkata Knight Riders", "venue": "Delhi", "result": None, "margin": None,
     "applied": False},
    {"home": "Rajasthan Royals", "away": "Gujarat Titans", "venue": "Jaipur", "result": None, "margin": None,
     "applied": False},
    {"home": "Chennai Super Kings", "away": "Lucknow Super Giants", "venue": "Chennai", "result": None, "margin": None,
     "applied": False},
    {"home": "Royal Challengers Bengaluru", "away": "Mumbai Indians", "venue": "Raipur", "result": None, "margin": None,
     "applied": False},
    {"home": "Punjab Kings", "away": "Delhi Capitals", "venue": "Dharamsala", "result": None, "margin": None,
     "applied": False},
    {"home": "Gujarat Titans", "away": "Sunrisers Hyderabad", "venue": "Ahmedabad", "result": None, "margin": None,
     "applied": False},
    {"home": "Royal Challengers Bengaluru", "away": "Kolkata Knight Riders", "venue": "Raipur", "result": None,
     "margin": None, "applied": False},
    {"home": "Punjab Kings", "away": "Mumbai Indians", "venue": "Dharamsala", "result": None, "margin": None,
     "applied": False},
    {"home": "Lucknow Super Giants", "away": "Chennai Super Kings", "venue": "Lucknow", "result": None, "margin": None,
     "applied": False},
    {"home": "Kolkata Knight Riders", "away": "Gujarat Titans", "venue": "Kolkata", "result": None, "margin": None,
     "applied": False},
    {"home": "Punjab Kings", "away": "Royal Challengers Bengaluru", "venue": "Dharamsala", "result": None,
     "margin": None, "applied": False},
    {"home": "Delhi Capitals", "away": "Rajasthan Royals", "venue": "Delhi", "result": None, "margin": None,
     "applied": False},
    {"home": "Chennai Super Kings", "away": "Sunrisers Hyderabad", "venue": "Chennai", "result": None, "margin": None,
     "applied": False},
    {"home": "Rajasthan Royals", "away": "Lucknow Super Giants", "venue": "Jaipur", "result": None, "margin": None,
     "applied": False},
    {"home": "Kolkata Knight Riders", "away": "Mumbai Indians", "venue": "Kolkata", "result": None, "margin": None,
     "applied": False},
    {"home": "Chennai Super Kings", "away": "Gujarat Titans", "venue": "Chennai", "result": None, "margin": None,
     "applied": False},
    {"home": "Sunrisers Hyderabad", "away": "Royal Challengers Bengaluru", "venue": "Hyderabad", "result": None,
     "margin": None, "applied": False},
    {"home": "Lucknow Super Giants", "away": "Punjab Kings", "venue": "Lucknow", "result": None, "margin": None,
     "applied": False},
    {"home": "Mumbai Indians", "away": "Rajasthan Royals", "venue": "Mumbai", "result": None, "margin": None,
     "applied": False},
    {"home": "Kolkata Knight Riders", "away": "Delhi Capitals", "venue": "Kolkata", "result": None, "margin": None,
     "applied": False},
]
...
def decommit_last():
    ...
    if abandoned:
        ...
        updated_points_data[loser]["overs_faced"] = _add_overs(updated_points_data[loser]["overs_faced"], lo_str)
...
def run_adjusted_simulation(num_simulations, what_if=False, override_matches=None):
    ...
    # Season-complete fast path
    if not pending:
        sorted_t = sorted(teams, key=lambda t: (base_pts[t], base_nrr[t]), reverse=True)
        # FIX: Safe by points logic must compare to 5th place (index 4) for top 4, and 3rd place (index 2) for top 2.
...
def run_pure_math_worker(args):
    ...
    for _ in range(sims):
        ...
        # Top 4 fractional math (Ignores NRR for mid-season)
        f4 = st[3][1]
...
def run_pure_math_simulation_parallel(total_sims=10000, processes=4, override_matches=None):
    ...
    # MATCH 70 OVERRIDE: Uses strict NRR because the season is over
    if not pending:
...
def run_full_simulation_and_prompt():
    ...
    # FIX: explicitly map "top4" and "top2" from pure_math output dict so it doesn't crash on CLI
